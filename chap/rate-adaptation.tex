...
\begin{figure}[h]
	\centering
	\vspace{10pt}
	\includegraphics[width = 1.0\linewidth]{clip/18.png}
	\vspace{10pt}
...
\begin{figure}[t]
	\vspace{10pt}
	\centering
	\includegraphics[width = 1.0\linewidth]{figures/Intervals.png}
	\vspace{10pt}
...
\begin{figure}[!t]
	\centering
	\vspace{10pt}
	\subfloat[]{\label{fig:19-1}\includegraphics[width=0.8\textwidth]{clip/19-1.png}} \\
	\subfloat[]{\label{fig:19-2}\includegraphics[width=0.8\textwidth]{clip/19-2.png}}
...
\begin{figure*}[!ht]
	...
	\subfloat[不同质量控制算法的质量等级均值]{
		\includegraphics[width=0.9\textwidth]{figures/Quality-all.png}
		\label{fig:quality-all}} \\
	\subfloat[不同质量控制算法的质量等级方差]{
		\includegraphics[width=0.9\textwidth]{figures/Variance-all.png}
...
\begin{figure*}[!ht]
	...
	\subfloat[PID和PDF算法的质量等级均值]{
		\includegraphics[width=0.9\textwidth]{figures/Quality-two.png}
		\label{fig:quality-two}} \\
	\subfloat[PID和PDF算法的质量等级方差]{
		\includegraphics[width=0.9\textwidth]{figures/Variance-two.png}
